...
define(['./workbox-44c91e4f'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/^https:\/\/imagenes-julio\.s3(?:\.[\w-]+)?\.amazonaws\.com\/.*/i, new workbox.CacheFirst({
